...
namespace DmailApp.Data.Migrations
{
    ...
    [Migration("20230102160314_AdditionalSeed")]
            ...
            modelBuilder.Entity("DmailApp.Data.Entities.Models.Mails.EventMail", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 15,
                            DateTimeOfSending = new DateTime(2022, 12, 12, 20, 0, 0, 0, DateTimeKind.Utc),
                            SenderId = 3,
                            Title = "Kava",
                            WasRead = false,
                            EventTime = new DateTime(2023, 11, 2, 16, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Id = 16,
                            DateTimeOfSending = new DateTime(2022, 11, 11, 20, 0, 0, 0, DateTimeKind.Utc),
                            SenderId = 3,
                            Title = "Večera kod kuma",
                            WasRead = false,
                            EventTime = new DateTime(2023, 6, 2, 16, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Id = 17,
                            DateTimeOfSending = new DateTime(2022, 8, 11, 20, 0, 0, 0, DateTimeKind.Utc),
                            SenderId = 5,
                            Title = "Proslava",
                            WasRead = false,
                            EventTime = new DateTime(2023, 7, 4, 16, 0, 0, 0, DateTimeKind.Utc)
                        });
                });
            ...
            modelBuilder.Entity("DmailApp.Data.Entities.Models.Mails.TextMail", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 10,
                            DateTimeOfSending = new DateTime(2022, 1, 3, 7, 0, 0, 0, DateTimeKind.Utc),
                            SenderId = 3,
                            Title = "Račun",
                            WasRead = false,
                            Content = "Račun od banke"
                        },
                        new
                        {
                            Id = 11,
                            DateTimeOfSending = new DateTime(2022, 2, 7, 7, 0, 0, 0, DateTimeKind.Utc),
                            SenderId = 5,
                            Title = "Slike s putovanja",
                            WasRead = false,
                            Content = "Slika1, Slika2, Slika3"
                        },
                        new
                        {
                            Id = 12,
                            DateTimeOfSending = new DateTime(2022, 3, 11, 7, 0, 0, 0, DateTimeKind.Utc),
                            SenderId = 5,
                            Title = "Podsjetnik",
                            WasRead = false,
                            Content = "Pripremi se za ispit"
                        },
                        new
                        {
                            Id = 13,
                            DateTimeOfSending = new DateTime(2022, 4, 12, 7, 0, 0, 0, DateTimeKind.Utc),
                            SenderId = 2,
                            Title = "Spotify-most lisened",
                            WasRead = false,
                            Content = "Michael Jackson, The Weekend, ..."
                        },
                        new
                        {
                            Id = 14,
                            DateTimeOfSending = new DateTime(2022, 6, 11, 7, 0, 0, 0, DateTimeKind.Utc),
                            SenderId = 5,
                            Title = "Kazna",
                            WasRead = false,
                            Content = "Dobili ste kaznu za prekoračenje brzine..."
                        });
                });
